...
class Renderer{
    constructor(renderer){
        ...
        this.canvasContext = this.canvas.getContext("2d"); // Get canvas 2d context
    ...
    draw(simulator){
        ...
        const gl = this.gl;
        const texture = simulator.particlePositionTexture;
        // console.log(texture);
        ...
        // //his.particlePositionTexture, wgl.RGBA, wgl.FLOAT, this.particlesWidth, this.particlesHeight, particlePositionsData, wgl.CLAMP_TO_EDGE, wgl.CLAMP_TO_EDGE, wgl.NEAREST, wgl.NEAREST);
        // // gl.texImage2D(gl.TEXTURE_2D, texture, 0, gl.FLOAT, 512, 512, wgl.CLAMP_TO_EDGE, wgl.CLAMP_TO_EDGE, wgl.NEAREST, wgl.NEAREST)
        ...
        var width = 512;
        var height = 512;
        const Gpixels = new Uint8Array(4 * width * height);
